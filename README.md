...
- Restore correct airfield population and usability in WDP
...
2. Locate your WDP installation directory
3. Navigate to the appropriate theater-folder (i.e. "Korea"), which can be found in the directory below:
 ```
 WeaponDeliveryPlanner\Database\
 ```
